...
public class SystemPropertyTestFactory {
	...
	public static PropertyDescriptor createAPropertyDescriptor() {
		PropertyDescriptor desc = new PropertyDescriptor(randomAlphabetic(5), SettingsType.BOOLEAN, "true");
		return desc;
	}
	...
	/**
	 * Gets a UserAppConfig for the specified user with a single boolean config
	 * element
	 * 
	 * @param any
	 * @return
	...
	public static UserAppConfig createAnyAppWithConfigElements(User any, String appName) {
		...
		app.setName(appName);
		AppConfigElement ace = new AppConfigElement(new AppConfigElementDescriptor(createAPropertyDescriptor()),
				"true");
	...
	public static App createAnyApp() {
		App app = new App("app", "app description", true);
		return app;
	}
